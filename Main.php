...
class Main extends PluginBase implements Listener{
    ...
    public function onEnable(){
        ...
        $this->getLogger()->info("§bFelicitari!");
		$this->getLogger()->info("§E facut de mine");
		$this->getLogger()->info("§eE facut de mine");
    }
   ...
   //             $nchim = 1;
                ...
                $p->sendMessage("§b-=§aa atins level: " . $this->getCurrentLevel($p). "§b=-");//xin config :v :v
				$this->getServer()->broadcastMessage("§b[§eGolden§6-§eLevel]§e Player §b" . $name . "§e a atins level: §b §e[§6" .$this->getCurrentLevel($p) . "§b]§l§e" .$name. "§2§l a crescut in level, Good Game");
